<?php /*a:3:{s:65:"/www/wwwroot/pingshen/application/admin/view/auth/admin_rule.html";i:1576644440;s:61:"/www/wwwroot/pingshen/application/admin/view/common/head.html";i:1576644440;s:61:"/www/wwwroot/pingshen/application/admin/view/common/foot.html";i:1576644440;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    layui.config({
        ...
        ptable=treeGrid.render({
            ...
            ,cols: [[
                ...
                {field: 'href', title: '控制器/方法', minWidth: 160},
                {field: 'authopen',align: 'center', title: '是否验证权限', minWidth: 130,toolbar: '#auth'},
                {field: 'menustatus',align: 'center',title: '菜单<?php echo lang("status"); ?>', minWidth: 100,toolbar: '#status'},
                {field: 'sort',align: 'center', title: '<?php echo lang("order"); ?>', minWinWidth: 80, templet: '#order'},
                {minWinWidth: 120,align: 'center', toolbar: '#action'}
            ]]
            ,page:false
        });
