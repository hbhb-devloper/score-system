<?php /*a:1:{s:75:"D:\wwwroot\buguniao\application\layuiadmin\view\component\upload\demo1.html";i:1571751279;}*/ ?>
    ...
    <div class="layui-row layui-col-space15">
      ...
      <div class="layui-col-md12">
        <div class="layui-card">
          ...
          <div class="layui-card-body">
            <button class="layui-btn test-upload-demoMore" lay-data="<?php echo url("","",true,false);?>">上传A</button>
            <button class="layui-btn test-upload-demoMore" lay-data="<?php echo url("","",true,false);?>">上传B</button>
            <button class="layui-btn test-upload-demoMore" lay-data="<?php echo url("","",true,false);?>">上传C</button>
          </div>
        </div>
      </div>
