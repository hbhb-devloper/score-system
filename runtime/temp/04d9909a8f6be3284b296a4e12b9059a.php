<?php /*a:3:{s:76:"E:\phpstudy1\PHPTutorial\WWW\bgn\application\admin\view\users\user_list.html";i:1571827209;s:72:"E:\phpstudy1\PHPTutorial\WWW\bgn\application\admin\view\common\head.html";i:1571041005;s:72:"E:\phpstudy1\PHPTutorial\WWW\bgn\application\admin\view\common\foot.html";i:1571041005;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script type="text/html" id="open">
    <input type="checkbox" name="is_open" value="{{d.id}}" lay-skin="switch" lay-text="开启|关闭" lay-filter="open" {{ d.is_open == 1 ? 'checked' : '' }}>
</script>
    ...
    layui.use(['table','form'], function() {
        ...
        var tableIn = table.render({
            ...
            cols: [[
                ...
                ,{field:'head_url', title: '头像',width:150}
