<?php /*a:3:{s:65:"/www/wwwroot/pingshen/application/admin/view/auth/admin_list.html";i:1576644440;s:61:"/www/wwwroot/pingshen/application/admin/view/common/head.html";i:1576644440;s:61:"/www/wwwroot/pingshen/application/admin/view/common/foot.html";i:1576644440;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    layui.use(['table','form','layer'], function() {
        ...
        var tableIn = table.render({
            ...
            cols: [[
				...
				,{field:'title', title: '<?php echo lang("userGroup"); ?>', minWidth:80}
                ,{field:'email', title: '邮箱', minWidth:170}
                ,{field:'tel', title: '<?php echo lang("tel"); ?>', minWidth:120}
                ,{field:'ip', title: '<?php echo lang("ip"); ?>',minWidth:90,hide:true}
                ,{field:'is_open', title: '<?php echo lang("status"); ?>',minWidth:80,toolbar: '#open'}
