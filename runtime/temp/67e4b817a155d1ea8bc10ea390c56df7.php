<?php /*a:3:{s:61:"/www/wwwroot/pingshen/application/admin/view/index/index.html";i:1576651513;s:61:"/www/wwwroot/pingshen/application/admin/view/common/head.html";i:1576644440;s:61:"/www/wwwroot/pingshen/application/admin/view/common/foot.html";i:1576644440;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="layui-main">
            <div class="admin-login-box">
                <a class="logo" style="left: 0;" href="<?php echo url('admin/index/index'); ?>">
                    <span style="font-size: 22px;"><?php echo config('app_name'); ?></span>
                </a>
                ...
                <div class="admin-side-refresh">
                    <span class="layui-icon layui-icon-refresh-3"></span>
                </div>
            </div>

            <ul class="layui-nav admin-header-item" lay-filter="side-top-right">
                <li class="layui-nav-item" id="cache">
                    <a href="javascript:;" class="layui-icon layui-icon-fonts-clear"> <?php echo lang('clearCache'); ?></a>
                </li>
<!--                <li class="layui-nav-item">-->
<!--                    <a href="<?php echo url(config('app.default_module').'/index/index'); ?>" target="_blank"><?php echo lang('home'); ?></a>-->
<!--                </li>-->
                <li class="layui-nav-item">
                    <a class="layui-icon layui-icon-template-1" href="javascript:;"> 主题</a>
    ...
    <div class="layui-footer footer footer-demo" id="admin-footer">
        <div class="layui-main">
            <p>2019 &copy;
                <a href="javascript:void()"><?php echo config('app_name'); ?></a>
            </p>
        </div>
    </div>
