...
layui.config({
    ...
    $('.admin-side-full').on('click', function () {
        if (localStorage.full == 0) {
            localStorage.full=1;
            $(this).children('span.icon').addClass('icon-shrink').removeClass('icon-enlarge')
            ...
            localStorage.full=0;
            $(this).children('span.icon').addClass('icon-enlarge').removeClass('icon-shrink')
    ...
    $('.admin-side-refresh').on('click', function(){
        $('.layui-tab-item.layui-show iframe').attr('src',$('.layui-tab-item.layui-show iframe').attr('src'))
    });
